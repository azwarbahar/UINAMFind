...
data class Magang (
    ...
    companion object CREATOR : Parcelable.Creator<Magang> {
        override fun createFromParcel(parcel: Parcel): Magang {
            return Magang(parcel)
        }

        override fun newArray(size: Int): Array<Magang?> {
