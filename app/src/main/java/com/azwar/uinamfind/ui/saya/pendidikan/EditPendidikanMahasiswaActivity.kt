...
import com.azwar.uinamfind.databinding.ActivityEditPendidikanMahasiswaBinding
...
class EditPendidikanMahasiswaActivity : AppCompatActivity() {
    private var pendidikan_id: String = ""
    private lateinit var sharedPref: PreferencesHelper
    private var id: String = ""
    private var pendidikan_pilih: String = ""

    private lateinit var pendidikanMahasiswa: PendidikanMahasiswa

    private lateinit var binding: ActivityEditPendidikanMahasiswaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEditPendidikanMahasiswaBinding.inflate(layoutInflater)
        setContentView(binding.root)
        sharedPref = PreferencesHelper(this)
        id = sharedPref.getString(Constanta.ID_USER).toString()
        pendidikanMahasiswa = intent.getParcelableExtra("pendidikan")!!
        initDataIntent(pendidikanMahasiswa)
        ...
        binding.imgBackEditPendidikan.setOnClickListener { finish() }

        binding.imgDeletePendidikan.setOnClickListener {
...
//            tgl_berakhir = null
    ...
    private fun startAddData(
        ...
        ApiClient.instances.updatePendidikanUser(
            pendidikanId,
            pendidikanPilih,
            tempat.toString(),
            jurusan.toString(),
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    if (kode.equals("1")) {
                        ...
                        SweetAlertDialog(
                            this@EditPendidikanMahasiswaActivity,
            ...
            override fun onFailure(
                ...
                dialogProgress.dismiss()
                SweetAlertDialog(this@EditPendidikanMahasiswaActivity, SweetAlertDialog.ERROR_TYPE)
                    .setTitleText("Gagal..")
                    .setContentText("Server tidak merespon")
                    .show()
            }
    ...
    private fun startDelet(pendidikanId: String) {
        // show progress loading
        val dialogProgress = SweetAlertDialog(this, SweetAlertDialog.PROGRESS_TYPE)
        dialogProgress.progressHelper.barColor = Color.parseColor("#A5DC86")
        dialogProgress.titleText = "Loading.."
        ...
        ApiClient.instances.deletePendidikanUser(pendidikanId)
    ...
    private fun initDataIntent(pendidikanMahasiswa: PendidikanMahasiswa) {
        pendidikan_id = pendidikanMahasiswa.id.toString()
        setupSpinner(pendidikanMahasiswa.pendidikan)
        binding.etNamaTempatPendidikan.setText(pendidikanMahasiswa.nama_tempat)
        binding.etJurusanPendidikan.setText(pendidikanMahasiswa.jurusan)
        binding.etTanggalMulai.setText(pendidikanMahasiswa.tanggal_masuk)
        var status = pendidikanMahasiswa.status_pendidikan
        if (status.equals("Selesai")) {
            binding.cbMasihMenjadiAnggota.isChecked = false
            binding.etTanggalBerakhir.setText(pendidikanMahasiswa.tanggal_berakhir)
        } else {
    ...
    private fun setupSpinner(pendidikan: String?) {
        ...
        spinnerJenisPengalaman?.onItemSelectedListener =
            object : AdapterView.OnItemSelectedListener {
                ...
                override fun onItemSelected(
                    ...
                    pendidikan_pilih = arrayPendidikan[position].toString()
