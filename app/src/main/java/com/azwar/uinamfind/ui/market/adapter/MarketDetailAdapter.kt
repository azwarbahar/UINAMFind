...
import com.azwar.uinamfind.databinding.ItemMarket2Binding
...
class MarketDetailAdapter(private var list: List<Market>) :
    RecyclerView.Adapter<MarketDetailAdapter.MyHolderView>() {

    class MyHolderView(private var binding: ItemMarket2Binding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolderView {
        val binding = ItemMarket2Binding.inflate(
            LayoutInflater.from(parent.context), parent, false
        )
        return MarketDetailAdapter.MyHolderView(binding)
    }
